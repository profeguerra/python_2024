...
def request_api_data(query_char):
  ...
  #hash1 que es? ver: https://passwordsgenerator.net/sha1-hash-generator/
  #password123 = CBFDAC6008F9CAB4083784CBD1874F76618D2A97
  #k anonimity just send the first5 chars = CBFDA
  #idempotent = https://dictionary.cambridge.org/es/diccionario/ingles/idempotent
